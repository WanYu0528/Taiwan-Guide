// 台灣地區列表
const regionLib = { 
  North: { name: "北部", region: "North" }, 
  Central: { name: "中部", region: "Central" }, 
  South: { name: "南部", region: "South" }, 
  EastOrOuter: { name: "東部及離島", region: "EastOrOuter" }
};
// 台灣各縣市資料
const cityLib = {
  ...
  HualienCounty: { name: "花蓮", icon: "balloon", region: "EastOrOuter" },
  TaitungCounty: { name: "臺東", icon: "flying-fish", region: "EastOrOuter" },
  KinmenCounty: { name: "金門", icon: "kinmen-island", region: "EastOrOuter" },
  LienchiangCounty: { name: "連江", icon: "jug", region: "EastOrOuter" },
};
// 搜尋主題列表
const themeLib = [
...
// 模式列表
const modeLib = {
  ScenicSpot: { title: "景點", color: "#3fb195", type: "ScenicSpot" },
  Restaurant: { title: "餐飲", color: "#ff9999", type: "Restaurant" },
  Hotel: { title: "旅宿", color: "#a79bfd", type: "Hotel" },
  Activity: { title: "活動", color: "#feb155", type: "Activity" },
};
// 隨機標語列表
const sloganLib = [
  ["探索。", "福爾摩沙"],
